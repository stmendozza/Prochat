...
/*estoy preguntando si ya se le dio click al botom de enviar*/
	if (isset($_POST['enviar'])) 
	{
		...
		$sql="SELECT nick,nombre,contraseña FROM tb_usuarios WHERE nick='".$nick."' AND contraseña='".$contraseña."'";
		/*despues de consultar recupera los datos que trajo la variable sql  */
		$resultado = $conexion->query( $sql );
 		/*pregunta el numero de filas traido en la variable resultado y si exactamente igual a 0 muestra un mensaje de alerta si no inicia sesion con la variable $nick y enlaza a chat.php*/
